...
import (
	...
	checkout "github.com/cloudwego/biz-demo/go-mall/webapi/hertz_gen/webapi/checkout"
...
func (h *CheckoutService) Run(req *checkout.CheckoutReq) (resp map[string]any, err error) {
	...
	carts, err := rpc.CartClient.GetCart(h.Context, &rpccart.GetCartReq{UserId: id})
	if err != nil {
		return nil, err
	}
	var total float32
